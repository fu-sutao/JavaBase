...
public class MD5 {
    ...
    //4轮循环中使用的生成函数(轮函数)g
    private  long g(int i, long b, long c, long d) {
        switch (i) {
            case 0:
                return (b & c) | ((~b) & d);
            case 1:
    ...
    public  String start(String message){
        ...
        long K = (long)(byteLen<<3);//k=bytelen*8
        ...
        if(rest <= 56){
            ...
            //处理分组
            //System.out.println(paddingBytes[1]+paddingBytes[2]);
    ...
    private  long[] divide(byte[] inputBytes,int start){
    ...
    private  long byte2unsign(byte b){
